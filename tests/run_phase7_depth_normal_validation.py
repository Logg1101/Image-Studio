...
def run_phase7_validation():
    ...
    artifact_dir = r"C:\Users\ankit\.gemini\antigravity\brain\70ac2ed5-1a7b-480d-85a4-fd3b8f0d0405\phase7_depth_normals"
    os.makedirs(artifact_dir, exist_ok=True)

    print("================================================================")
    print("PHASE 7 — TRUE SURFACE DEPTH & NORMAL RECONSTRUCTION VALIDATION")
    print("================================================================")
    ...
    for key, angle_deg, label in directions:
        ...
        debug_dir = f"outputs/phase7_{key}"
    ...
    # Crops for direct inspection of 3D curved surfaces & normal modulation
    crops = {
    ...
    full_path = os.path.join(artifact_dir, "phase7_directional_trio_full_comparison.png")
    full_strip.save(full_path)
    print(f"Saved full Phase 7 comparison to {full_path}")
